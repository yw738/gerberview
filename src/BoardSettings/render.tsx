...
const USE_OUTLINE_LABEL = '使用轮廓层来表示板形'
const GAP_FILL_LABEL = '间隙填充极限'//gap fill limit
const GAP_FILL_UNITS = 'mm'
const OVERRIDE_LABEL = '覆盖'//override 钻孔
const COORD_FORMAT_LABEL = '整数/十进制坐标格式'//integer/decimal coordinate format
const ZERO_SUPRESSION_LABEL = '补零位置'// zero suppression
const UNITS_LABEL = '单位'//units
  ...
  return (
    ...
    >
      <Field
        ...
        defaultValue={defaultValue}
        options={[
          {value: 'L', label: '后补零'},//leading
          {value: 'T', label: '前补零'},//trailing
        ]}
      />
    </OverridableField>
  )
